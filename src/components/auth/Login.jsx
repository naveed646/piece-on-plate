...
function Login() {
  ...
  const handleSubmitt = async (e) => {
    e.preventDefault();
    const { email, password } = singnUpInfo;
    if ( !email || !password) {
...
>
  <div className="text-black text-center max-w-xl bg-gradient-to-tr from-zinc-800 to-orange-200 opacity-90 p-6 rounded">
    ...
    <p className="font-semibold">
      ...
      <div className=" bg-gradient-to-tr from-zinc-900 to-orange-900 text-white p-6 mr-10 ml-10 rounded-xl h-120 shadow-lg w-full max-w-sm">
